...
export const solarPumps = [
    ...
    {
        image: S9,
        name: "Dayliff SUNFLO-A",
        description: "DAYLIFF SUNFLO-A pumps are specifically designed for PV solar-powered water supply from wells and boreholes. They are of rotary screw design and material of construction for rotary screw is stainless steel with a ruber stator. Pumps are of simple structure and feature an inbuilt controller.",
        oldPrice: "Price",
        moreDescription:"More",
    ...
    {
        image: S14,
        name: "Dayliff Sunverter",
        description: "Dayliff Sunverter is an established range of advanced AC/DC inverters specially designed for solar-powering AC motors in various water pumping applications. As well as a general upgrade of the electronics and functionality an important new feature is hybrid capability that enables concurrent operation with direct AC power from mains or generator supply while prioritising solar supply. It is adaptable to all AC motor types and can be retro fitted to existing AC supply installations in solarisation projects.",
        oldPrice: "Price",
        moreDescription:"More",
