...
<div className="relative flex flex-col items-center mx-auto lg:flex-row-reverse lg:max-w-5xl lg:mt-12 xl:max-w-6xl py-16">
    ...
    <div className="w-full h-64 lg:w-1/2 lg:h-auto">
        <img className=" h-fit w-full object-cover" src={GC} alt="Winding mountain road" />
    </div>
    ...
    <div
        ...
        <div className="flex flex-col p-12 md:px-16">
            <h2 className="text-2xl font-medium uppercase text-sky-800 lg:text-4xl">GRAY WATER TREATMENT</h2>
            <p className="mt-4">
            ...
            <p className='mt-2'>We can purify grey water sources separated from domestic wastewater using MBR modules and make them suitable for reuse.</p>
