...
const ContactUs: React.FC = (props: Props) => {
  return (
    <div className="py-16 mt-24 max-w-5xl max-lg:max-w-3xl mx-auto bg-white my-6 font-inter">
            ...
            <div className="grid lg:grid-cols-3 items-start gap-4 p-2 shadow-[0_2px_10px_-3px_rgba(6,81,237,0.3)] rounded-lg mt-12">
                ...
                <div className="bg-sky-800 rounded-lg p-6 h-full max-lg:order-1">
                ...
                <div className="p-4 lg:col-span-2">
                    <form>
                        ...
                        <button type="button"
                            className="mt-12 flex items-center justify-center text-sm lg:ml-auto max-lg:w-full rounded-lg px-4 py-3 tracking-wide text-white bg-sky-800 hover:bg-sky-700">
