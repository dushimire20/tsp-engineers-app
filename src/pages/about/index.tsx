            ...
            <div className="md:flex w-full mt-16 gap-8">
                ...
                <div className="md:w-[50%]  flex-col ">
                    ...
                    <ol className='ml-6 list-disc'>
                        <li>Our Mission</li>
                        <li>Preserve Rwanda's cultural heritage through technology, documentation, and restoration efforts.</li>
                        <li>Engage local communities in heritage conservation, ensuring that everyone plays a role in protecting the country’s history.</li>
                        <li>Promote education and awareness by offering learning resources and virtual experiences that showcase the significance of Rwanda’s cultural sites and traditions.</li>
                    </ol>
                </div>
            ...
            <div className="md:flex w-full mt-16">
                <div className="md:w-[50%] md:mr-[20px] flex-col ">
                    ...
                    <ol className='ml-6 list-disc'>
                        ...
                        <li>Virtual Heritage Tours: Using AR and VR technologies, we offer immersive virtual experiences that bring Rwanda’s cultural landmarks to life.</li>
                        <li>Community Engagement: We empower local communities to take part in heritage conservation efforts through discussions, volunteer programs, and collaborative initiatives.</li>
                        <li>Education & Awareness: We partner with schools and organizations to create educational programs and modules that teach the importance of cultural preservation.</li>
                        <li>Artifact Documentation and Authentication: We ensure the authenticity of cultural artifacts through proper documentation and digital verification methods.</li>
                        <li>Risk & Safety Planning: We assess potential threats to heritage sites and develop disaster preparedness plans to safeguard them against natural and human-made risks.</li>
